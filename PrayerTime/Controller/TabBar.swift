...
class TabBar: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        let tabBarItem1 = UITabBarItem(title: "Prayer Time", image: UIImage(systemName: "circle"), selectedImage: nil)
        ...
        let tabBarItem2 = UITabBarItem(title: "Cat", image: UIImage(systemName: "circle"), selectedImage: nil)
